...
module.exports = {
    ...
    return Absenteeism
      .findAndCountAll({
        ...
        attributes: [
          ...
          'name',
          'status_id',
          [sequelize.fn('date_format', sequelize.col('absenteeism.created_at'), '%d-%b-%y'), 'created_at'],
          [sequelize.fn('date_format', sequelize.col('absenteeism.updated_at'), '%d-%b-%y'), 'updated_at']
        ]
      })
  ...
  delete(req, res) {
    return Absenteeism
      ...
      .then(absenteeism => absenteeism.update({
